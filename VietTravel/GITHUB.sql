...
insert into CSKH (Hoten , DOB , Emails , phone , AddressNV , chucvu, maphongban , matkhau , anhcanhan)
select 'Clindy Sherman', '1954-1-19', 'Clindy@gmail.com' , 165631288,'Glen Ridge, New Jersey, The United State' , 'CEO' , 'CCS16102000X' , 'ClindySherman001' , BulkColumn From OPENROWSET(BULK 'D:\VietTravel\Used\CSKH\cindy-sherman.jpg', SINGLE_BLOB) as picture
...
@ma int
as begin
	delete ChuyenDi Where MaHDV = @ma
	delete HuongDanVien where MaHDV = @ma
end
