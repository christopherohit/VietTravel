...
namespace VietTravel
{
    public partial class Signin : Form
    {
        ...
        public Button ciris { get { return this.InBut; } }
        public TextBox Pass { get { return this.PassBox; } }
        public Signin()
        {
            InitializeComponent();
        }
            ...
            if (InBut.Text == "Login")
            {
                ...
                else
                {
                    ...
                    if (UserBox.Text != "")
                    {
                        ...
                        {
                            string layen = "select HoTen from CSKH Where Emails = @emails";
                            SqlCommand sqll2 = new SqlCommand(layen, con);
                            sqll2.Parameters.AddWithValue("@emails", nickname);
                            SqlDataAdapter ada = new SqlDataAdapter(sqll2);
                            DataTable r = new DataTable();
